...
[중요] feedback과 nextLine은 반드시 위 recognizedText 그대로를 기준으로 작성하세요. "아마 이런 뜻으로 말하려던 것 같다"고 다른 문장을 추측해서 그 추측한 문장에 대해 반응하지 마세요. 인식된 문장 자체가 다소 어색하거나 뜻이 불분명해도, 그 문장을 있는 그대로 받아들이고 그에 맞게 반응하세요 (전혀 말이 안 되는 경우에만 타당하지 않다고 판단하세요).
